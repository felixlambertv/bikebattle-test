...
async function main() {
  ...
  const garageBtn = await page.$x('//*[@id="worldMap"]/div[2]/div[2]/a/button');
  await garageBtn[0].click();
  await page.waitForNavigation({
    waitUntil: "networkidle0"
  });

  const selectBike = await page.$x('//*[@id="root"]/main/div[2]/div/div/div[1]/div/div/div');
  await selectBike[0].click();
